        ...
        <div className="flex flex-col space-y-8 h-full w-full">
            ...
            <form className="h-full space-y-6">
                ...
                <div className="label-input-set">
                    ...
                    <div className="flex flex-row space-x-2 !h-12 !rounded-md input-base text-sm input-base">
                        <input className="placeholder:text-xs w-full h-full" placeholder="가격을 입력하세요."></input>
                        <p>원</p>
                    </div>
                </div>
                <div className="label-input-set">
                ...
                <div className="label-input-set">
                    ...
                    <textarea className="text-sm !h-32 !rounded-md border-[#d9d9d9] placeholder:text-[10px] placeholder:leading-5 p-3 border placeholder:text-gray-600" placeholder={textGuide}></textarea>
                </div>
                <div className="label-input-set">
